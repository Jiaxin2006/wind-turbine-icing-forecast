"""
cluster_show.py — CNN-LSTM-Attention embedding 聚类可视化与一致性分析。
...
# 模型结构超参（必须与 mix.py / param.py 训练时一致）
CNN_CHANNELS         = 16
CNN_KERNEL           = 3
LSTM_HID             = 128
TRANS_DMODEL         = 128
...
# ---------- Model (CNN-LSTM-Attention, must match mix.py / param.py) ----------
